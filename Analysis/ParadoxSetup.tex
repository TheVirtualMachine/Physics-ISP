\chapter{Stating the Twin Paradox}
	...
	\section{Approach to resolution of the paradox}
		It is commonly thought that general relativity is needed to resolve this paradox because Alice is in an accelerating frame of reference and special relativity cannot handle accelerating frames of reference \autocite{bouttell}.
		That is not true.
	...
	\section{Notation and assumptions}
		...
		\subsection{Assumptions}
			\subsubsection{Values}
				We will say that Alice travels a distance of \SI{4}{\lightyear} at a speed of \SI{0.8}{\clight} since these are nice numbers to work with \autocite[\pno~35]{kogut2012introduction}.
